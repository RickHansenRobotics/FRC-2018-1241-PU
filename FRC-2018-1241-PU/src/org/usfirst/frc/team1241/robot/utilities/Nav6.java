package org.usfirst.frc.team1241.robot.utilities;
 ...
 * @author Scott
 */
public class Nav6 extends SensorBase implements PIDSource, LiveWindowSendable, Runnable {
     ...
     */
    public Nav6(SerialPort serial_port, byte update_rate_hz) {
     ...
     * @param serial_port BufferingSerialPort object to use
     */
    public Nav6(SerialPort serial_port) {
