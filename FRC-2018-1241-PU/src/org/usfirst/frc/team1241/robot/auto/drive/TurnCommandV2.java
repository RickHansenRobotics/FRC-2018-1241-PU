 ...
 */
public class TurnCommandV2 extends Command {
	 ...
	 */
	public TurnCommandV2(double angle, double speed, double timeOut){
		this (angle, speed, timeOut, 2.5);
	}
	
	public TurnCommandV2(double angle, double speed, double timeOut, double tolerance) {
		this.angle = angle;
		this.speed = speed;
	...
	protected void execute() {
		Robot.drive.turnDriveV2(angle, speed, 1.5);
	}
