 ...
 *
 */
public class LeftLeftScaleSwitch extends CommandGroup {

    public LeftLeftScaleSwitch() {
		...
		//addSequential(new QuinticBezierDrivePath (new Point(0,0), new Point (-15,84), new Point (-27,130), new Point (-41,182), new Point (-23, 230), new Point(24,284), 20, 0.05, 3.5, 1 ));
