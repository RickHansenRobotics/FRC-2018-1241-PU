 ...
 * @since 13/01/17
 */
public class DriveCommandV2 extends Command {
	...
	public DriveCommandV2(double setPoint, double speed, double angle, double timeOut) {
		this(setPoint, speed, angle, timeOut, setPoint, angle, speed, 2.5);
	}
	
	public DriveCommandV2(double setPoint, double speed, double angle, double timeOut, double tolerance) {
		this(setPoint, speed, angle, timeOut, setPoint, angle, speed, tolerance);
	}
	public DriveCommandV2(double setPoint, double speed, double angle, double timeOut, double turnDistance, double angleTwo, double speedTwo) {
		this(setPoint, speed, angle, timeOut, turnDistance, angleTwo, speedTwo, 2.5);
	}
	

    public DriveCommandV2(double setPoint, double speed, double angle, double timeOut, double turnDistance, double angleTwo, double speedTwo, double tolerance) {
